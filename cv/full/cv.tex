...
\newcommand{\enableProjects}{false}
...
\cv{
  ...
  \personalInfo{
    \name{Tommaso Papini}
    \address
      {15 The Ridgeway, London, W3 8LW, United Kingdom}
      {15 The Ridgeway, Londra, W3 8LW, Regno Unito}
  ...
  \personalSkills
    ...
    \computerSkills
      {\listSection{
        ...
        \listItem{gamedev tools: Unity, Unreal Engine 4, Blender}
      ...
      {\listSection{
        ...
        \listItem{strumenti per gamedev: Unity, Unreal Engine 4, Blender}
