...
\cv{
  ...
  \personalInfo{
    ...
    \homepage{https://github.com/oddlord}
  ...
  \personalSkills
    ...
    \otherLanguages{
      ...
      \lastLanguage{French}{Francese}{A1}{A1}{A1}{A1}{A1}
    }
    ...
    \computerSkills
      {\listSection{
        ...
        \listItem{tools \& software: Unity, Jinja2, Git, Github, QEMU, VirtualBox, SASS, Eclipse, Windows, Linux, dotfiles, Python Fabric, Jekyll, LaTeX}
      }}
      {\listSection{
        ...
        \listItem{strumenti \& software: Unity, Jinja2, Git, Github, QEMU, VirtualBox, SASS, Eclipse, Windows, Linux, dotfiles, Python Fabric, Jekyll, LaTeX}
      }}
