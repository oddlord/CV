...
%--------------------------------------------------------------
		...
		\ecvitem{Principali materie/Competenze professionali apprese}{Data Warehousing, Teoria dei Linguaggi di Programmazione, Analisi Quantitativa dei Sistemi, Informatica Teorica.}
...
%		\ecvitem[10pt]{}{Inserire qui ogni altra informazione utile, ad esempio persone di riferimento, referenze, etc\ldots Facoltativo.}
		...
		\ecvitem{}{Cerithidea Decollata: rete neurale che simula la predizione delle maree di alcune chiocciole intertidali. \url{https://github.com/tommy39/CerithideaDecollata-Model}}
		\ecvitem[10pt]{}{Visualizzazione di algoritmi in HTML5. \url{https://github.com/tommy39/Tesi-Triennale}}
