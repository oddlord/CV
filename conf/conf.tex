...
\newcommand{\ecvItemIfTitleCommand}[1]{%
  \expandafter\newcommand\csname #1\endcsname[2]{%
    \ifBoolThen{#1Bool}{\ecvitem{\csname #1String\endcsname}{\ifEngIta{##1}{##2}}}%
  }%
}%
%\newcommand{\ecvItemIfTitleListCommand}[1]{%
%  \expandafter\newcommand\csname #1\endcsname[1]{%
%    \ifBoolThen{#1Bool}{\ecvitem{\csname #1String\endcsname}{\begin{ecvitemize}##1\end{ecvitemize}}%
%  }%
%}%
...
\ecvItemIfTitleCommand{courses}

%\ecvItemIfTitleListCommand{projects}
