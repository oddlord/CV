...
\newcommand{\addURL}[1]{\ifBoolThen{urlsBool}{ - \url{#1}}}
%------------------------------------------------------
...
%------------------------------------------------------
% Meta-newcommand functions declarations
%------------------------------------------------------
...
\newcommand{\ecvItemIfTitleCommand}[2]{%
  \expandafter\newcommand\csname #1\endcsname[2]{%
    \ifBoolThen{#2Bool}{\ecvitem{\csname #1String\endcsname}{\ifEngIta{##1}{##2}}}%
  }%
}%
\newcommand{\ecvItemIfTitleListCommand}[2]{%
  \expandafter\newcommand\csname #1\endcsname[1]{%
    \ifBoolThen{#2Bool}{\ecvitem{\csname #1String\endcsname}{\begin{ecvitemize}##1\end{ecvitemize}}}%
  }%
}%
...
\newcommand{\blueItemListCommand}[1]{%
  \expandafter\newcommand\csname #1\endcsname[2]{%
    \ecvblueitem{\csname #1String\endcsname}{\begin{ecvitemize}\ifEngIta{##1}{##2}\end{ecvitemize}}%
  }%
}%
\newcommand{\blueItemIfListCommands}[2]{%
  \expandafter\newcommand\csname #1\endcsname[1]{%
    \ifBoolThen{#2Bool}{\ecvblueitem{\csname #1String\endcsname}{\begin{ecvitemize}##1\end{ecvitemize}}}%
  }%
}%
...
\blueItemIfListCommands{otherProjects}{projects}
\blueItemIfListCommands{publications}{publications}
