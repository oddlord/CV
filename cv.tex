...
\cv{
  ...
  \workExperience
    ...
    {Giugno 2017}{Secondment}
      ...
      \jobDescription
        {REMIND project for the use of computational techniques to improve compliance to reminders within smart environments. Knowledge transfer between the Universities of Florence an Jaén in order to share experiences on techniques for Activity Recognition (especially based on fuzzy logic and stochastic models) and on the creation of an AR dataset.}
