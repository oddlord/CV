...
\begin{document}
  \begin{europasscv}
    ...
    \personalSkills
      ...
      \computerSkills
        {\listSection{
          \listItem{programming languages: Java, C, C++, shell scripting, MIPS assembler, LaTeX, Matlab, HTML5, XML, declarative programming, SQL, $\lambda$-calculus, Python, Javascript, CSS}
          \listItem{tools \& software: Jinja2, Git, Github, QEMU, VirtualBox, SASS, Eclipse, Windows, Linux, dotfiles, Python Fabric, Jekyll}
        }}
        {\listSection{
          \listItem{linguaggi di programmazione: Java, C, C++, shell scripting, assembler MIPS, LaTeX, Matlab, HTML5, XML, programmazione dichiarativa, SQL, $\lambda$-calcolo, Python, Javascript, CSS}
          \listItem{strumenti \& software: Jinja2, Git, Github, QEMU, VirtualBox, SASS, Eclipse, Windows, Linux, dotfiles, Python Fabric, Jekyll}
        }}
    ...
    \additionalInfo
      ...
      \references
        {
          \reference{Prof. Enrico Vicario, University of Florence (Italy)} 
          \reference{Prof. Pierluigi Crescenzi, University of Florence (Italy)}
          \reference{Prof. Gregorio Landi, University of Florence (Italy)}
          \reference{Pedro Ferreira, CERN, Geneva (Switzerland)}
        }
        {
          \reference{Prof. Enrico Vicario, Università degli Studi di Firenze (Italia)} 
          \reference{Prof. Pierluigi Crescenzi, Università degli Studi di Firenze (Italia)}
          \reference{Prof. Gregorio Landi, Università degli Studi di Firenze (Italia)}
          \reference{Pedro Ferreira, CERN, Ginevra (Svizzera)}
        }
